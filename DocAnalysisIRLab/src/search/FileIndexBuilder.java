...
//		    	System.out.println("Adding: " + f.getPath());
	...
	public static void main(String[] args) throws Exception {
		...
		// Path for the test and gov files
//		String test_path = "../lab1-q1-test-collection/documents";
// 		String index_path = "src/search/lucene.index";

		String gov_path = "../gov-test-collection/documents";
		String index_path = "src/gov/lucene.index";

		FileIndexBuilder b = new FileIndexBuilder(index_path);

		// build index for lab1-test-collection
//		b.addFiles(FileFinder.GetAllFiles(test_path, null , true),
//				false /*clear_old_index = false if adding*/);

		// build index for gov-test-collection
		b.addFiles(FileFinder.GetAllFiles(gov_path, null, true), false);
